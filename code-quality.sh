#!/bin/bash
mkdir s3
aws s3 cp s3://devex-deploy/springboot-demo-app.zip /root/.jenkins/workspace/custom-actions/Sonarmy-default-app-2023-10-16-1697442398799/s3
unzip s3/springboot-demo-app.zip -d /root/.jenkins/workspace/custom-actions/Sonarmy-default-app-2023-10-16-1697442398799/s3
